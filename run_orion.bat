...
if not exist "client\gui_client.py" (
    echo.
    echo [!] CRITICAL ERROR: "run_orion.bat" cannot find the project files.
    echo.
    echo [TIP] Did you move this file out of the folder? 
    echo       Please return it to the PROJECT-ORION folder and 
    echo       RIGHT-CLICK it -> "Send to Desktop (create shortcut)" instead.
    echo.
    pause
    exit /b
)
